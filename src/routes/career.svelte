...
<main>
	<h2>Career</h2>
	<p>
		<strong>Christopher McCulloh</strong> has been crafting websites for
		<strong>two decades</strong>
	</p>

	<div class="two-column">
		<div>
			<p>
				Christopher currently works on the <strong>UX R&D team</strong> at
